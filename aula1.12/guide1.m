...
% Last Modified by GUIDE v2.5 30-Oct-2018 19:01:26
...
function pushbutton1_Callback(hObject, eventdata, handles)
    num1 = str2num(get(handles.edit1,'default'));
    num2 = str2num(get(handles.edit2,'default'));
    num3 = num1+num2;
    set(handles.text2,'String',num2str(num3));
